...
parcelRequire = (function (modules, cache, entry, globalName) {
...
})(
  {
    ...
    '../../../../frontend/src/style/base/reset.css': [
      function (require, module, exports) {
    ...
    '../../../../frontend/src/style/base/global.css': [
      function (require, module, exports) {
        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
    ...
    '../../../../frontend/src/style/layout/header.css': [
      function (require, module, exports) {
        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      ...
      {
        '../base/global.css': '../../../../frontend/src/style/base/global.css',
        _css_loader: '../../../../node_modules/parcel-bundler/src/builtins/css-loader.js',
      },
    ],
    '../../../../frontend/src/style/layout/footer.css': [
      function (require, module, exports) {
        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
    ...
    '../../../../frontend/src/style/layout/home.css': [
      function (require, module, exports) {
        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
    ...
    '../../../../frontend/src/style/layout/portfolio.css': [
      function (require, module, exports) {
        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
    ...
    '../../../../frontend/src/style/compnenents/button.css': [
      function (require, module, exports) {
        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
    ...
    '../../../../frontend/src/style/layout/sign up.css': [
      function (require, module, exports) {
        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
    ...
    '../../../../frontend/src/style/layout/Edit portfolio.css': [
      function (require, module, exports) {
        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
    ...
    '../../../../frontend/src/style/layout/search result.css': [
      function (require, module, exports) {
        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
    ...
    '../../../../frontend/src/style/Index.css': [
      ...
      {
        '../style/base/reset.css': '../../../../frontend/src/style/base/reset.css',
        '../style/base/global.css': '../../../../frontend/src/style/base/global.css',
        '../style/layout/header.css': '../../../../frontend/src/style/layout/header.css',
        '../style/layout/footer.css': '../../../../frontend/src/style/layout/footer.css',
        '../style/layout/home.css': '../../../../frontend/src/style/layout/home.css',
        '../style/layout/portfolio.css': '../../../../frontend/src/style/layout/portfolio.css',
        '../style/layout/search.css': '../../../../frontend/src/style/layout/search.css',
        '../style/compnenents/button.css': '../../../../frontend/src/style/compnenents/button.css',
        '../style/layout/sign up.css': '../../../../frontend/src/style/layout/sign up.css',
        '../style/layout/Edit portfolio.css': '../../../../frontend/src/style/layout/Edit portfolio.css',
        '../style/layout/search result.css': '../../../../frontend/src/style/layout/search result.css',
        _css_loader: '../../../../node_modules/parcel-bundler/src/builtins/css-loader.js',
      },
    ],
    'main.js': [
      function (require, module, exports) {
        ...
        function AddEducationOrWork() {
          ...
          return '<div class="margin-left experience-container ">\n                \n                <div class="form__group "> \n                    <label class="form__label"for="'
            .concat(type, 'title">')
            .concat(workOrEducation(type), ' Title</label>\n                    <input class="form__input"id="')
            .concat(type, 'title" type="')
            .concat(workOrEducation(type), 'title" placeholder="')
            .concat(
              type === 'work' ? 'Senior Developer' : 'High school diploma',
              '" >\n                </div>\n                <div class="form__group "> \n                    <label class="form__label " for="'
            )
            .concat(type, 'place">')
            .concat(workOrEducation(type), ' Place</label>\n                    <input class="form__input" id="')
            .concat(type, 'place" type="')
            .concat(workOrEducation(type), 'place" placeholder="')
            .concat(
              type === 'work' ? 'e.g Asiacell Telecome' : 'Baghdad College',
              '" >\n                </div>\n                <div class="form__group "> \n                    <label class="form__label " for="'
            )
            .concat(type, 'description">')
            .concat(workOrEducation(type), ' Description</label>\n                    <input class="form__input" id="')
            .concat(type, 'description" type="')
            .concat(
              type,
              'description"  >\n                </div>\n                <div class="form__group "> \n                    <label class="form__label" for="'
            )
            .concat(type, 'years">')
            .concat(workOrEducation(type), ' Years</label>\n                    <input class="form__input" id="')
            .concat(type, 'years" type="')
            .concat(type, 'years" placeholder="')
            .concat(
      ...
      { '../../../../frontend/src/style/Index.css': '../../../../frontend/src/style/Index.css' },
    ],
      ...
      function (require, module, exports) {
        ...
        var signUp = (exports.signUp = /*#__PURE__*/ (function () {
          var _ref2 = _asyncToGenerator(
            /*#__PURE__*/ _regeneratorRuntime().mark(function _callee2(email, password, passwordConfirm, name) {
              var res;
              return _regeneratorRuntime().wrap(
    ...
    'search.js': [
      function (require, module, exports) {
        ...
        var search = (exports.search = /*#__PURE__*/ (function () {
          var _ref = _asyncToGenerator(
            /*#__PURE__*/ _regeneratorRuntime().mark(function _callee(selectedTags) {
              var res;
              return _regeneratorRuntime().wrap(
                function _callee$(_context) {
                  while (1)
      ...
      },
      {
        ...
        './alerts': 'alerts.js',
        './../../utils/appError': '../../utils/appError.js',
      },
    ],
    'index.js': [
      function (require, module, exports) {
        ...
        var logOutBtn = document.querySelectorAll('.logout__btn');
        ...
        var userProjectsForm = document.querySelector('.form-user-projects');
        var errorWindow = document.querySelector('.error-container');
        if (userPhotoForm) {
              ...
              if (sentence) {
                ...
                if (!Array.isArray(sentence)) {
                  ...
                  for (var _i = 0; _i < words.length; _i++)
                    words[_i] = words[_i].charAt(0).toUpperCase() + words[_i].slice(1);
                }
                return words;
              }
            };
        ...
        var workOrEducation = function workOrEducation() {
          ...
          var experienceContainer = container.querySelectorAll('.experience-container');
          var formEntries = [];
          if (experienceContainer) {
            var workExperienceArray = experienceContainer.forEach(function (el) {
              if (type === 'work') {
                formEntries.push({
                  workPlace: el.querySelector('#'.concat(type, 'place')).value,
                  workTitle: el.querySelector('#'.concat(type, 'title')).value,
                  workDescription: el.querySelector('#'.concat(type, 'description')).value,
                  workYears: el.querySelector('#'.concat(type, 'years')).value,
                  startYear: el.querySelector('#'.concat(type, 'years')).value.split('-')[0],
                  endYear: el.querySelector('#'.concat(type, 'years')).value.split('-')[1],
                });
              }
              if (type === 'education') {
                formEntries.push({
                  educationPlace: el.querySelector('#'.concat(type, 'place')).value,
                  educationTitle: el.querySelector('#'.concat(type, 'title')).value,
                  educationDescription: el.querySelector('#'.concat(type, 'description')).value,
                  educationYears: el.querySelector('#'.concat(type, 'years')).value,
                  startYear: el.querySelector('#'.concat(type, 'years')).value.split('-')[0],
                  endYear: el.querySelector('#'.concat(type, 'years')).value.split('-')[1],
                });
              }
            ...
            if (type === 'work') {
              return {
                workExperience: [].concat(formEntries),
              };
            }
            if (type === 'education') {
              return {
        ...
        if (userEducationForm) {
          userEducationForm.addEventListener('submit', function (e) {
            e.preventDefault();
            var form = workOrEducation('education');
            (0, _updateSettings.updateSettings)(form, 'data');
          });
        }
        if (userPasswordForm)
        ...
        if (userProjectsForm) {
          userProjectsForm.addEventListener(
            'submit',
            /*#__PURE__*/ (function () {
              var _ref2 = _asyncToGenerator(
        ...
        if (searchForm) {
          ...
          var searchBtn = document.querySelectorAll('.search_btn');
          ...
          function handleSearchBtnClick(e) {
            ...
            (0, _search.search)(selectedTagsByQuestion);
          }
